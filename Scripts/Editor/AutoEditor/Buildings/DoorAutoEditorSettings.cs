...
namespace DaftAppleGames.Editor.AutoEditor.Buildings
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "DoorAutoEditorSettings", menuName = "Settings/Buildings/DoorAutoEditor", order = 1)]
    public class DoorAutoEditorSettings : BaseAutoEditorSettings
    {
